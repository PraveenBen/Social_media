...
INSERT INTO `members` (`member_id`, `firstname`, `middlename`, `lastname`, `address`, `email`, `contact_no`, `age`, `gender`, `username`, `password`, `image`, `birthdate`, `mobile`, `status`, `work`, `religion`) VALUES
(1, 'Praveen', 'T', 'Benakannanavar', 'Saraviaq', 'Praveenbenakannanavar@gmail.com', '953505419', 18, 'Male', 'Praveen', 'Password', 'images/male5.jpg', 'q', 'q', 'q', 'q', 'q'),
